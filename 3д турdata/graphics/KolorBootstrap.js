...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'3д турdata/3д тур_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'3д турdata/3д тур_messages_','.xml');
}
...
function addKolorAnalytics(pPlugID)
{
	...
	{
		var kolorAnalyticsJS = new ktools.Script("KolorAnalyticsJS", crossDomainTargetUrl+"3д турdata/graphics/KolorAnalytics/KolorAnalytics.min.js", [], true);
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"3д турdata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"3д турdata/graphics/KolorArea/KolorArea.min.js", [], true);
...
function addKolorBox(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"3д турdata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"3д турdata/graphics/KolorBox/KolorBox.min.js", [], true);
